...
public class ActivityProfile extends Activity {
	...
	private void updateSelectedSkin(String skinType) {
		skins = new Skin(skinType).getSkins();
	...
	private void openSkin(String newSkinType) {
	    ...
	    args.putInt("skinNameResource", getResources().getIdentifier("skin_" + newSkinType.toLowerCase(Locale.CANADA) + "_display", "string", getPackageName()));
