...
public class DialogSkin extends DialogFragment {
	...
	private void loadImages() {
		...
		textView.setText(getString(R.string.skin) + " " + getString(skinNameResource));
		tankView.setImageResource(skin.getTankImages()[3]);
		bombView.setImageResource(skin.getBombImage());
	...
	private void loadTexts() {
		if(getArguments().getBoolean("isOwned")) {
			...
			textView2.setText(getString(R.string.cost) + ": " + skin.getCost());
